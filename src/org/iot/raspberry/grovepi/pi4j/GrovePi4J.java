...
public class GrovePi4J implements GrovePi {
  ...
  public GrovePi4J() throws IOException, com.pi4j.io.i2c.I2CFactory.UnsupportedBusNumberException {
  ...
  public GroveRgbLcd getLCD() throws IOException {
    try{                                        //JL: try-catch block added, the constructor throws the exception
      return new GroveRgbLcdPi4J();             //and this method must have same signature of the one it overrides
